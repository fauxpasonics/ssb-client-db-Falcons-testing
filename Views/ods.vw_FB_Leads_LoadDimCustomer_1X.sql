...
CREATE VIEW [ods].[vw_FB_Leads_LoadDimCustomer_1X] AS ( --Change "Source" to the correct source
...
--base set
		SELECT
			...
			, CAST(REPLACE(REPLACE(REPLACE(z.created_time,'T',' '),'-04:00',''),RIGHT(z.created_time,6),'') AS DATETIME) [SSCreatedDate] --createddate
		...
		--SELECT COUNT(*)			
		FROM stg.FB_Leads_080717 z WITH (NOLOCK) --Change To Source Table
		WHERE 1=1
