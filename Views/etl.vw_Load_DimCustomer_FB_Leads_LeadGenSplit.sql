...
CREATE VIEW [etl].[vw_Load_DimCustomer_FB_Leads_LeadGenSplit] AS 
...
--base set
		SELECT
			...
			, CAST(REPLACE(REPLACE(z.created_time,'T',' '),'-06:00','') AS DATETIME) [SSCreatedDate] --createddate
		...
		--SELECT COUNT(*)			
		FROM src.vw_FB_LeadGenSplitTest_20180128 z WITH (NOLOCK) --Change To Source Table
		WHERE 1=1
