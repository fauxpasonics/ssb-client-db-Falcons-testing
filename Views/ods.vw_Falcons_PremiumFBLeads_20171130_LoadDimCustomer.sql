...
CREATE VIEW [ods].[vw_Falcons_PremiumFBLeads_20171130_LoadDimCustomer] AS ( --Change "Source" to the correct source
...
--base set
		SELECT
			...
			, 'Falcons_PremiumFBLeads_20171130' AS [SourceSystem] --Put source name such as TM or CRM_Contact
			...
			, z.adset_id AS[ExtAttribute2] --nvarchar(100)
			...
			, CAST( REPLACE(REPLACE(REPLACE(created_time,'T',' '),'-04:00',''),'-06:00','') AS DATETIME) [SSCreatedDate] --createddate
		...
		--SELECT COUNT(*)			
		FROM stg.Falcons_PremiumFBLeads_20171130 z WITH (NOLOCK) --Change To Source Table
		WHERE 1=1
