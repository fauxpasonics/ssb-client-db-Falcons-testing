...
CREATE VIEW [ods].[vw_FB_Leads_LoadDimCustomer_20180109] AS ( --Change "Source" to the correct source
...
--base set
		SELECT
			...
			, z.ad_name AS[ExtAttribute10] --nvarchar(1000)
			...
			, CAST(REPLACE(LEFT(z.created_time, CHARINDEX('-', z.created_time)-1),'T',' ') AS DATETIME) [SSCreatedDate] --createddate
		...
		--SELECT COUNT(*)			
		FROM stg.FB_Leads_20180104 z WITH (NOLOCK) --Change To Source Table
		WHERE 1=1
