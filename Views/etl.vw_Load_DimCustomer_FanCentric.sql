...
--base set
		SELECT
			...
			, CASE WHEN ISNULL(z.CUST_ID,'') != '' THEN NULL ELSE 'FC-' + CAST(z.CUST_ID AS NVARCHAR(200)) END	
			 AS [Customer_Matchkey] /*Standard for macthkeys are ‘TM-xxxx’, ‘Pac-xxxx’ depending on source, 
