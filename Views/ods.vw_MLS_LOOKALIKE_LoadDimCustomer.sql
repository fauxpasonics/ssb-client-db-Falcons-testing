...
CREATE VIEW [ods].[vw_MLS_LOOKALIKE_LoadDimCustomer] AS (
...
--base set
		...
		/*AddressPrimary*/
            , CONCAT(c.Addr1,' ',c.Addr2) AS [AddressPrimaryStreet]
			...
			FROM Falcons.src.MLS_LOOKALIKE c
