...
CREATE VIEW [rpt].[vw_FactTicketSeat_Falcons] AS (
...
SELECT  dd.CalDate SaleDate ,
        ...
        dsh.Active SeasonHeaderIsActive ,
        ds.SeasonName ,
        ds.SeasonYear ,
        ds.SeasonClass ,
        ds.Active SeasonIsActive ,
        ...
        deh.GameNumber EventHeaderGameNumber ,
        ...
        --fi.IsResold ,
        --( CAST(dd_resold.CalDate AS DATETIME)
        --  + CAST(dt_resold.Time24 AS DATETIME) ) ResoldDateTime ,
...
FROM    rpt.vw_FactInventory_FalconsPSL (NOLOCK) fi
        ...
        INNER JOIN dbo.DimSeat (NOLOCK) dst ON fi.DimSeatId = dst.DimSeatId
                                               AND ds.ManifestId = dst.ManifestId
