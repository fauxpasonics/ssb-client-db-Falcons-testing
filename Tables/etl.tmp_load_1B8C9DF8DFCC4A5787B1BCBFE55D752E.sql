CREATE TABLE [etl].[tmp_load_1B8C9DF8DFCC4A5787B1BCBFE55D752E]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1B8C9DF8DFCC4A5787B1BCBFE55D752E_ss] ON [etl].[tmp_load_1B8C9DF8DFCC4A5787B1BCBFE55D752E] ([SourceSystem], [SSID])
GO
