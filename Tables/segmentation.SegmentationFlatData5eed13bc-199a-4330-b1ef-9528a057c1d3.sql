CREATE TABLE [segmentation].[SegmentationFlatData5eed13bc-199a-4330-b1ef-9528a057c1d3]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData5eed13bc-199a-4330-b1ef-9528a057c1d3] ADD CONSTRAINT [pk_SegmentationFlatData5eed13bc-199a-4330-b1ef-9528a057c1d3] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData5eed13bc-199a-4330-b1ef-9528a057c1d3] ON [segmentation].[SegmentationFlatData5eed13bc-199a-4330-b1ef-9528a057c1d3] ([_rn])
GO
