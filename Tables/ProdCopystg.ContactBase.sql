CREATE TABLE [ProdCopystg].[ContactBase]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ContactBa__ETL_C__7DB89C09] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ContactBa__ETL_U__7EACC042] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__ContactBa__ETL_I__7FA0E47B] DEFAULT ((0)),
...
GO
ALTER TABLE [ProdCopystg].[ContactBase] ADD CONSTRAINT [PK__ContactB__7EF6BFCDD200CA71] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
