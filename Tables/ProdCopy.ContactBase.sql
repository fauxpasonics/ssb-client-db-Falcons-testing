...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ContactBa__ETL_C__6F6A7CB2] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ContactBa__ETL_U__705EA0EB] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__ContactBa__ETL_I__7152C524] DEFAULT ((0)),
...
GO
ALTER TABLE [ProdCopy].[ContactBase] ADD CONSTRAINT [PK__ContactB__5C66259B8DC3E690] PRIMARY KEY CLUSTERED  ([ContactId])
GO
