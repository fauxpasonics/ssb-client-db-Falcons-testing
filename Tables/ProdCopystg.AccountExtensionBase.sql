CREATE TABLE [ProdCopystg].[AccountExtensionBase]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__AccountEx__ETL_C__7ADC2F5E] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__AccountEx__ETL_U__7BD05397] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__AccountEx__ETL_I__7CC477D0] DEFAULT ((0)),
...
GO
ALTER TABLE [ProdCopystg].[AccountExtensionBase] ADD CONSTRAINT [PK__AccountE__7EF6BFCD28A8089C] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
