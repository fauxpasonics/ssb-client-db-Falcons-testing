...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__AccountBa__ETL_C__69B1A35C] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__AccountBa__ETL_U__6AA5C795] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__AccountBa__ETL_I__6B99EBCE] DEFAULT ((0)),
...
GO
ALTER TABLE [ProdCopy].[AccountBase] ADD CONSTRAINT [PK__AccountB__349DA5A62BF0CAF6] PRIMARY KEY CLUSTERED  ([AccountId])
GO
