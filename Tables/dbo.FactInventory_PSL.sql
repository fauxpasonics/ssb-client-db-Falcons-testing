CREATE TABLE [dbo].[FactInventory_PSL]
(
...
GO
ALTER TABLE [dbo].[FactInventory_PSL] ADD CONSTRAINT [PK_FactInventory_PSL] PRIMARY KEY CLUSTERED  ([FactInventoryId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimEventId_DimSeatId_PSL] ON [dbo].[FactInventory_PSL] ([DimEventId], [DimSeatId])
GO
CREATE NONCLUSTERED INDEX [IDX_IsAttended_PSL] ON [dbo].[FactInventory_PSL] ([IsAttended])
GO
CREATE NONCLUSTERED INDEX [IDX_IsAvailable_PSL] ON [dbo].[FactInventory_PSL] ([IsAvailable])
GO
CREATE NONCLUSTERED INDEX [IDX_IsSold_PSL] ON [dbo].[FactInventory_PSL] ([IsSold], [IsSaleable]) INCLUDE ([DimEventId], [PostedDimClassTMId])
GO
CREATE NONCLUSTERED INDEX [IDX_SoldDimCustomerId_PSL] ON [dbo].[FactInventory_PSL] ([SoldDimCustomerId])
GO
