CREATE TABLE [rpt].[TM_Tkt_History]
(
[id] [bigint] NULL,
...
[seq_num] [bigint] NULL,
[block_purchase_price] [numeric] (18, 6) NULL,
...
[full_price] [numeric] (18, 6) NULL,
[purchase_price] [numeric] (18, 6) NULL,
...
[section_id] [numeric] (18, 6) NULL,
[row_id] [numeric] (18, 6) NULL,
...
[ledger_id] [int] NULL,
[pc_ticket] [numeric] (18, 6) NULL,
[pc_tax] [numeric] (18, 6) NULL,
[pc_licfee] [numeric] (18, 6) NULL,
[pc_other1] [numeric] (18, 6) NULL,
[pc_other2] [numeric] (18, 6) NULL,
[tax_rate_a] [numeric] (18, 6) NULL,
[tax_rate_b] [numeric] (18, 6) NULL,
[tax_rate_c] [numeric] (18, 6) NULL,
[orig_acct_rep_id] [int] NULL,
[ticket_seq_id] [int] NULL,
[SourceTable] [varchar] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
CREATE NONCLUSTERED INDEX [IDX_event_id] ON [rpt].[TM_Tkt_History] ([event_id])
GO
