CREATE TABLE [ProdCopystg].[CustomerAddressBase]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__CustomerA__ETL_C__0371755F] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__CustomerA__ETL_U__04659998] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__CustomerA__ETL_I__0559BDD1] DEFAULT ((0)),
...
GO
ALTER TABLE [ProdCopystg].[CustomerAddressBase] ADD CONSTRAINT [PK__Customer__7EF6BFCD583B710A] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
