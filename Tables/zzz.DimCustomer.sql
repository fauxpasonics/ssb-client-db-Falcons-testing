...
GO
	...
	CREATE TRIGGER [zzz].[isdeleted_updated]
	ON [zzz].[DimCustomer]
	AFTER INSERT, UPDATE
	AS 
	BEGIN
...
GO
	...
	CREATE TRIGGER [zzz].[matchkey_updated]
	ON [zzz].[DimCustomer]
	AFTER UPDATE
	AS 
	BEGIN
	...
	END
GO
ALTER TABLE [zzz].[DimCustomer] ADD CONSTRAINT [PK_DimcustomerID] PRIMARY KEY CLUSTERED  ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IDX_AccountId] ON [zzz].[DimCustomer] ([AccountId]) INCLUDE ([CustomerType], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_AccountType] ON [zzz].[DimCustomer] ([AccountType])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_addressfourstatus] ON [zzz].[DimCustomer] ([AddressFourIsCleanStatus]) INCLUDE ([AddressFourStreet], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressFour] ON [zzz].[DimCustomer] ([AddressFourIsCleanStatus], [IsDeleted]) INCLUDE ([AddressFourCity], [AddressFourCountry], [AddressFourCounty], [AddressFourState], [AddressFourStreet], [AddressFourSuite], [AddressFourZip], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_addressOnestatus] ON [zzz].[DimCustomer] ([AddressOneIsCleanStatus]) INCLUDE ([AddressOneStreet], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressOne] ON [zzz].[DimCustomer] ([AddressOneIsCleanStatus], [IsDeleted]) INCLUDE ([AddressOneCity], [AddressOneCountry], [AddressOneCounty], [AddressOneState], [AddressOneStreet], [AddressOneSuite], [AddressOneZip], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_addressprimarystatus] ON [zzz].[DimCustomer] ([AddressPrimaryIsCleanStatus]) INCLUDE ([AddressPrimaryStreet], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressPrimary] ON [zzz].[DimCustomer] ([AddressPrimaryIsCleanStatus], [IsDeleted]) INCLUDE ([AddressPrimaryCity], [AddressPrimaryCountry], [AddressPrimaryCounty], [AddressPrimaryState], [AddressPrimaryStreet], [AddressPrimarySuite], [AddressPrimaryZip], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_addressthreestatus] ON [zzz].[DimCustomer] ([AddressThreeIsCleanStatus]) INCLUDE ([AddressThreeStreet], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressThree] ON [zzz].[DimCustomer] ([AddressThreeIsCleanStatus], [IsDeleted]) INCLUDE ([AddressThreeCity], [AddressThreeCountry], [AddressThreeCounty], [AddressThreeState], [AddressThreeStreet], [AddressThreeSuite], [AddressThreeZip], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_addresstwostatus] ON [zzz].[DimCustomer] ([AddressTwoIsCleanStatus]) INCLUDE ([AddressTwoStreet], [DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_AddressTwo] ON [zzz].[DimCustomer] ([AddressTwoIsCleanStatus], [IsDeleted]) INCLUDE ([AddressTwoCity], [AddressTwoCountry], [AddressTwoCounty], [AddressTwoState], [AddressTwoStreet], [AddressTwoSuite], [AddressTwoZip], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_CustomerType] ON [zzz].[DimCustomer] ([CustomerType])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_emailonestatus] ON [zzz].[DimCustomer] ([EmailOneIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailOne])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailOne] ON [zzz].[DimCustomer] ([EmailOneIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailOne], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_emailprimarystatus] ON [zzz].[DimCustomer] ([EmailPrimaryIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailPrimary])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailPrimary] ON [zzz].[DimCustomer] ([EmailPrimaryIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailPrimary], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_emailtwostatus] ON [zzz].[DimCustomer] ([EmailTwoIsCleanStatus]) INCLUDE ([DimCustomerId], [EmailTwo])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_EmailTwo] ON [zzz].[DimCustomer] ([EmailTwoIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [EmailTwo], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_customer_matchkey] ON [zzz].[DimCustomer] ([FirstName], [LastName], [customer_matchkey]) INCLUDE ([DimCustomerId], [SourceSystem], [SourceSystemPriority], [SSCreatedDate], [SSID], [SSUpdatedDate])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_CompanyName] ON [zzz].[DimCustomer] ([IsDeleted]) INCLUDE ([CompanyName], [CustomerType], [DimCustomerId], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_isdeleted] ON [zzz].[DimCustomer] ([IsDeleted]) INCLUDE ([DimCustomerId], [SourceSystem], [SSID])
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomer_IsBusiness] ON [zzz].[DimCustomer] ([IsDeleted], [IsBusiness]) INCLUDE ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_matchkey_updated] ON [zzz].[DimCustomer] ([matchkey_updatedate] DESC) INCLUDE ([DimCustomerId], [SourceSystem], [SSID])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phonebusinessstatus] ON [zzz].[DimCustomer] ([PhoneBusinessIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneBusiness])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneBusiness] ON [zzz].[DimCustomer] ([PhoneBusinessIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneBusiness], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phonecellstatus] ON [zzz].[DimCustomer] ([PhoneCellIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneCell])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneCell] ON [zzz].[DimCustomer] ([PhoneCellIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneCell], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phonefaxstatus] ON [zzz].[DimCustomer] ([PhoneFaxIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneFax])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneFax] ON [zzz].[DimCustomer] ([PhoneFaxIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneFax], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phonehomestatus] ON [zzz].[DimCustomer] ([PhoneHomeIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneHome])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneHome] ON [zzz].[DimCustomer] ([PhoneHomeIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneHome], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phoneotherstatus] ON [zzz].[DimCustomer] ([PhoneOtherIsCleanStatus]) INCLUDE ([DimCustomerId], [PhoneOther])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhoneOther] ON [zzz].[DimCustomer] ([PhoneOtherIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhoneOther], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_phoneprimarystatus] ON [zzz].[DimCustomer] ([PhonePrimaryIsCleanStatus]) INCLUDE ([DimCustomerId], [PhonePrimary])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_PhonePrimary] ON [zzz].[DimCustomer] ([PhonePrimaryIsCleanStatus], [IsDeleted]) INCLUDE ([CustomerType], [DimCustomerId], [PhonePrimary], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceSystem] ON [zzz].[DimCustomer] ([SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_SSID] ON [zzz].[DimCustomer] ([SSID])
GO
ALTER TABLE [zzz].[DimCustomer] ADD CONSTRAINT [UK_SSID] UNIQUE NONCLUSTERED  ([SSID], [SourceSystem])
GO
