CREATE TABLE [segmentation].[SegmentationFlatData526cdcea-db09-4197-8a68-55c3d4beaf13]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData526cdcea-db09-4197-8a68-55c3d4beaf13] ADD CONSTRAINT [pk_SegmentationFlatData526cdcea-db09-4197-8a68-55c3d4beaf13] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData526cdcea-db09-4197-8a68-55c3d4beaf13] ON [segmentation].[SegmentationFlatData526cdcea-db09-4197-8a68-55c3d4beaf13] ([_rn])
GO
