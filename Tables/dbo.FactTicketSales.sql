...
GO
ALTER TABLE [dbo].[FactTicketSales] ADD CONSTRAINT [PK_FactTicketSales] PRIMARY KEY NONCLUSTERED  ([FactTicketSalesId])
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_dbo__FactTicketSales] ON [dbo].[FactTicketSales]
GO
CREATE NONCLUSTERED INDEX [IDX_DeltaHashKey] ON [dbo].[FactTicketSales] ([DeltaHashKey])
GO
CREATE NONCLUSTERED INDEX [IDX_DimClassTM] ON [dbo].[FactTicketSales] ([DimClassTMId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimCustomerId] ON [dbo].[FactTicketSales] ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimDatetId] ON [dbo].[FactTicketSales] ([DimDateId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimEventId] ON [dbo].[FactTicketSales] ([DimEventId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimEventId_Plus] ON [dbo].[FactTicketSales] ([DimEventId]) INCLUDE ([CompCode], [DimCustomerId], [DimPlanId], [DimPriceCodeId], [QtySeat])
GO
CREATE NONCLUSTERED INDEX [IDX_DimItemId] ON [dbo].[FactTicketSales] ([DimItemId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimPlanId] ON [dbo].[FactTicketSales] ([DimPlanId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimPlanTypeId] ON [dbo].[FactTicketSales] ([DimPlanTypeId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimPriceCodeId] ON [dbo].[FactTicketSales] ([DimPriceCodeId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimSalesCodeId] ON [dbo].[FactTicketSales] ([DimSalesCodeId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimSeasonId] ON [dbo].[FactTicketSales] ([DimSeasonId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimSeatIdStart] ON [dbo].[FactTicketSales] ([DimSeatIdStart])
GO
CREATE NONCLUSTERED INDEX [IDX_DimSeatTypeId] ON [dbo].[FactTicketSales] ([DimSeatTypeId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimTicketClassId] ON [dbo].[FactTicketSales] ([DimTicketClassId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimTicketTypeId] ON [dbo].[FactTicketSales] ([DimTicketTypeId])
GO
CREATE NONCLUSTERED INDEX [IDX_DimTimeId] ON [dbo].[FactTicketSales] ([DimTimeId])
GO
CREATE NONCLUSTERED INDEX [IDX_IsHost] ON [dbo].[FactTicketSales] ([IsHost])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [dbo].[FactTicketSales] ([SSID_event_id], [SSID_section_id], [SSID_row_id], [SSID_seat_num], [SourceSystem])
GO
