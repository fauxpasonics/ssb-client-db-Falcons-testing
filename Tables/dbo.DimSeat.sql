...
GO
CREATE NONCLUSTERED INDEX [IX_DimSeat__DimSeatId_IsDeleted__Includes__SectionName_RowName_Seat] ON [dbo].[DimSeat] ([DimSeatId], [IsDeleted]) INCLUDE ([RowName], [Seat], [SectionName])
GO
CREATE NONCLUSTERED INDEX [IDX_DimSeat_ManifestID_SectionName] ON [dbo].[DimSeat] ([ManifestId], [SectionName])
GO
CREATE NONCLUSTERED INDEX [IDX_RowName] ON [dbo].[DimSeat] ([RowName])
GO
CREATE NONCLUSTERED INDEX [IDX_Seat] ON [dbo].[DimSeat] ([Seat])
GO
