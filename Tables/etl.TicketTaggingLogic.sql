...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____02323713] DEFAULT (getdate()),
[ETL__UpdatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____03265B4C] DEFAULT (getdate()),
