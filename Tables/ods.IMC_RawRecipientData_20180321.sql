CREATE TABLE [ods].[IMC_RawRecipientData_20180321]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EventTimestamp] ON [ods].[IMC_RawRecipientData_20180321] ([EventTimestamp])
GO
CREATE NONCLUSTERED INDEX [IX_EventType] ON [ods].[IMC_RawRecipientData_20180321] ([EventType])
GO
CREATE NONCLUSTERED INDEX [IX_MailingID] ON [ods].[IMC_RawRecipientData_20180321] ([MailingID])
GO
CREATE NONCLUSTERED INDEX [IX_RecipientID] ON [ods].[IMC_RawRecipientData_20180321] ([RecipientID])
GO
CREATE NONCLUSTERED INDEX [IX_ReportID] ON [ods].[IMC_RawRecipientData_20180321] ([ReportID])
GO
