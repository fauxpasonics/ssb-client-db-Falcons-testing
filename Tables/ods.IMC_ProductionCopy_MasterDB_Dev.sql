CREATE TABLE [ods].[IMC_ProductionCopy_MasterDB_Dev]
(
...
GO
ALTER TABLE [ods].[IMC_ProductionCopy_MasterDB_Dev] ADD CONSTRAINT [PK_IMC_ProductionCopy_MasterDB_Dev] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__DeltaHashKey] ON [ods].[IMC_ProductionCopy_MasterDB_Dev] ([ETL__DeltaHashKey])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__Key] ON [ods].[IMC_ProductionCopy_MasterDB_Dev] ([RECIPIENT_ID], [Email])
GO
