CREATE TABLE [segmentation].[SegmentationFlatData1a08be0e-e94f-4227-ac83-ad58f644772b]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData1a08be0e-e94f-4227-ac83-ad58f644772b] ADD CONSTRAINT [pk_SegmentationFlatData1a08be0e-e94f-4227-ac83-ad58f644772b] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData1a08be0e-e94f-4227-ac83-ad58f644772b] ON [segmentation].[SegmentationFlatData1a08be0e-e94f-4227-ac83-ad58f644772b] ([_rn])
GO
