CREATE TABLE [dbo].[tmp_KORE_ExtSysToContact_put]
(
[Id] [bigint] NULL,
...
[httpAction] [varchar] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Description] [varchar] (23) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
)
GO
CREATE NONCLUSTERED INDEX [idx_KORE_ExtSysToContact_put_ID] ON [dbo].[tmp_KORE_ExtSysToContact_put] ([Id])
GO
