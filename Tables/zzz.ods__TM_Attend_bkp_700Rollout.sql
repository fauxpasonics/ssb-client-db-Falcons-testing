...
GO
CREATE NONCLUSTERED INDEX [NCIX_ods_TM_Attend_event_id] ON [zzz].[ods__TM_Attend_bkp_700Rollout] ([event_id], [section_id], [row_id], [seat_num]) INCLUDE ([HashKey], [id], [InsertDate]) WITH (DATA_COMPRESSION = ROW)
GO
