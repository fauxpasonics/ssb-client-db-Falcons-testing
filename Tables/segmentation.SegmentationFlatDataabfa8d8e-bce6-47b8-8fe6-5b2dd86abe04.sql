CREATE TABLE [segmentation].[SegmentationFlatDataabfa8d8e-bce6-47b8-8fe6-5b2dd86abe04]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataabfa8d8e-bce6-47b8-8fe6-5b2dd86abe04] ADD CONSTRAINT [pk_SegmentationFlatDataabfa8d8e-bce6-47b8-8fe6-5b2dd86abe04] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataabfa8d8e-bce6-47b8-8fe6-5b2dd86abe04] ON [segmentation].[SegmentationFlatDataabfa8d8e-bce6-47b8-8fe6-5b2dd86abe04] ([_rn])
GO
