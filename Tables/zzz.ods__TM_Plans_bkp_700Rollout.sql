...
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[ods__TM_Plans_bkp_700Rollout] ([ticket_status], [event_id], [section_id], [row_id]) INCLUDE ([seat_num]) WITH (DATA_COMPRESSION = ROW)
GO
