...
GO
CREATE NONCLUSTERED INDEX [IDX_FactInventory_DimEventId_IsSaleable_IsSold] ON [dbo].[FactInventory] ([DimEventId], [IsSaleable], [IsSold]) INCLUDE ([PostedDimClassTMId]) WITH (DATA_COMPRESSION = ROW)
GO
CREATE NONCLUSTERED INDEX [IDX_IsAttended] ON [dbo].[FactInventory] ([IsAttended])
GO
CREATE NONCLUSTERED INDEX [IDX_IsAvailable] ON [dbo].[FactInventory] ([IsAvailable])
GO
CREATE NONCLUSTERED INDEX [IDX_IsSold] ON [dbo].[FactInventory] ([IsSold], [IsSaleable]) INCLUDE ([DimEventId], [PostedDimClassTMId]) WITH (DATA_COMPRESSION = ROW)
GO
