...
SET ANSI_NULLS ON
GO
CREATE PROC [apietl].[sp_Load_ods_VisionCritical_Falcons_RespondentAttributes]
AS
MERGE ods.VisionCritical_Falcons_RespondentAttributes AS target
USING
	(
	SELECT SSID_SurveyId ,
           ...
           AttributeKey ,
           AttributeValue 
		   FROM apietl.vw_RespondentAttributes
	) AS source
