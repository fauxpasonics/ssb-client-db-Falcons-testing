...
SET ANSI_NULLS ON
GO
CREATE PROC [apietl].[sp_Load_ods_VisionCritical_Falcons_QuestionResponse]
AS
MERGE ods.VisionCritical_Falcons_QuestionResponse AS target
USING
	(
	SELECT SSID_SurveyId ,
           ...
           Response ,
           scaleValue ,
           preCode FROM apietl.vw_QuestionResponse
	) AS source
