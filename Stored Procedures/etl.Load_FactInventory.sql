...
*/
	...
	LEFT OUTER JOIN dbo.DimPriceCode dpc_st ON dpc_st.SSID_event_id = de.SSID_event_id AND dpc_st.SSID_price_code = dst.DefaultPriceCode AND de.SourceSystem = dpc_st.SourceSystem
	LEFT OUTER JOIN dbo.DimClassTM dctm ON dctm.ETL_SSID_class_id = dst.DefaultClass AND de.SourceSystem = dctm.ETL_SourceSystem
