...
CREATE PROCEDURE [etl].[Cust_Refresh_MV_FactTicketSales_Falcons_HM]
...
BEGIN
	...
	INTO #SrcData
	FROM [rpt].[vw_FactTicketSales_Falcons_HM]

	CREATE NONCLUSTERED INDEX IDX_DimSeatId ON #SrcData (DimSeatId)

	MERGE rpt.MV_FactTicketSales_Falcons_HM AS myTarget
