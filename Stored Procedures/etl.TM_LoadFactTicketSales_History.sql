...
SELECT 
	...
	LEFT OUTER JOIN etl.vw_DimClassTMId_FactKeyLookup dctm ON dctm.ClassName = tkt.class_name AND dctm.ETL_SourceSystem = (SELECT etl.fnGetClientSetting('TM-SourceStyem')) AND dPlan.DimPlanId > 0 AND dctm.DimClassTMId > 0 
